...
//MARK: - 展现动画协议
protocol HMZPhotoBrowserPresentDelegate: NSObjectProtocol {
...
protocol HMZPhotoBrowserDismissDelegate: NSObjectProtocol {
    /// 解除转场的图像视图 (包含起始位置)
...
class HMZPhotoBrowserAnimator: NSObject,UIViewControllerTransitioningDelegate {
    /// 展现代理
    var presentDelegate: HMZPhotoBrowserPresentDelegate?
    /// 解除代理
    var dismissDelegate: HMZPhotoBrowserDismissDelegate?
    ...
    ///  - parameter dismissDelegate:
    func setDelegateParams(presentDelegate: HMZPhotoBrowserPresentDelegate, indexPath: NSIndexPath, dismissDelegate: HMZPhotoBrowserDismissDelegate) {
...
extension HMZPhotoBrowserAnimator: UIViewControllerAnimatedTransitioning {
    ...
    */
    ...
    private func presentAnimation(transitionContext: UIViewControllerContextTransitioning) {
        ...
        // 2. 获取目标控制器 - 照片查看控制器
        let toVC = transitionContext.viewControllerForKey(UITransitionContextToViewControllerKey) as! HMZPhotoBrowserViewController
        // 隐藏 collectionView
